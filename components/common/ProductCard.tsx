const ProductCard = ({ product, addToCart }:any) => {
    return (
        ...
        <div className="max-w-[350px] w-full  h-[350px] ml-[20px] rounded-[10px] group overflow-hidden">
            <div className="!h-full bg-white shadow-md rounded-[10px] max-w-sm  border-[1px] border-gray-400 relative">
              
                    <img className="rounded-[10px] h-full top-0 left-0 w-full absolute group-hover:scale-110 " src={product.images[0]} alt="product image" />
                    ...
                    <div className="px-5 pb-5 w-full h-full flex flex-col justify-center gap-[10px] relative z-2  ">
                        <a href="#" className="hover:underline text-white">
                            <h3 className="text-white font-semibold text-xl tracking-tight ">{product.title}</h3>
                        </a>
                        ...
                        <div className="flex items-center justify-between  ">
                            <p className="text-gray-200 text-md font-bold">{product.category.name}</p>
                        </div>
                        <div className="flex items-center justify-between">
